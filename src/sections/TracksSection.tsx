                ...
                >
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-2 text-white/40 group-hover:text-purple-400 transition-colors">
                      <span className="font-mono text-xs sm:text-sm">Explore track</span>
                      <ArrowUpRight 
                        size={14} 
                        className="sm:w-4 sm:h-4 transform group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" 
                      />
                    </div>
                  </div>
                </SpotlightCard>
